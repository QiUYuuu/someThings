<template>
  <div style="width: 110px; height: 42px">
    <div
      v-show="!VerifyShow"
      :style="{
        cursor: locked ? 'no-drop' : 'pointer',
        'background-color': locked ? '#c4c9c0' : 'white',
        border: locked ? '' : '1px solid #fec200',
        color: locked ? 'white' : '#fec200',
      }"
      class="verifyBtn"
    ...
    <div class="verifyMain" v-show="VerifyShow">
      <div class="bck"></div>
      <components
        style="z-index: 1000"
        is="VerifySlide"
        ...
        :barSize="barSize"
        ref="instance"
        @close="closeMainContent"
        @success="verifySuccess"
      ></components>
    </div>

    <!-- 确定按钮容器 -->
    <!-- <div @click="checkCode" v-show="false" style="width: 0; height: 0">
      <slot name="check">
...
export default {
  ...
  created() {
    this.btnMsg = this.$props.btnText;
  },
